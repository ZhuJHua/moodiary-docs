...
Overwriting is safe, but regular [backups](./sync#backup) are always a good habit.
:::
...
- The app cannot read other apps' directories, and a system "clear storage" action will also wipe your diary.
